...
internal static class BookingServiceLoggingExtension
{
    ...
    private static readonly Action<ILogger, int, DateOnly, int, Exception?> _createBookingAsyncAvailableUnitsNotFound;
    private static readonly Action<ILogger, int, DateOnly, int, Exception?> _createBookingAsyncEnd;
    ...
    static BookingServiceLoggingExtension()
    {
        ...
        _createBookingAsyncNightsIsNegativeOrZero = LoggerMessage.Define<int, DateOnly, int>(
            LogLevel.Information,
            new EventId(101_001),
            "CreateBookingAsync(rentalId: {@rentalId}, start: {@start}, nights: {@nights}) - Nights is negative or zero");
        _createBookingAsyncRentalNotFound = LoggerMessage.Define<int, DateOnly, int>(
            LogLevel.Information,
            new EventId(101_002),
            "CreateBookingAsync(rentalId: {@rentalId}, start: {@start}, nights: {@nights}) - Rental not found");
        _createBookingAsyncAvailableUnitsNotFound = LoggerMessage.Define<int, DateOnly, int>(
            LogLevel.Information,
            new EventId(101_003),
            "CreateBookingAsync(rentalId: {@rentalId}, start: {@start}, nights: {@nights}) - Available for booking units not found");
        _createBookingAsyncEnd = LoggerMessage.Define<int, DateOnly, int>(
            LogLevel.Debug,
            new EventId(101_999),
    ...
    public static void CreateBookingAsyncNightsIsNegativeOrZero(this ILogger logger, int rentalId, DateOnly start, int nights)
    {
        _createBookingAsyncNightsIsNegativeOrZero(logger, rentalId, start, nights, null);
    }

    public static void CreateBookingAsyncRentalNotFound(this ILogger logger, int rentalId, DateOnly start, int nights)
    {
        _createBookingAsyncRentalNotFound(logger, rentalId, start, nights, null);
    }

    public static void CreateBookingAsyncAvailableUnitsNotFound(this ILogger logger, int rentalId, DateOnly start, int nights)
    {
        _createBookingAsyncAvailableUnitsNotFound(logger, rentalId, start, nights, null);
    }

    public static void CreateBookingAsyncEnd(this ILogger logger, int rentalId, DateOnly start, int nights)
    {
